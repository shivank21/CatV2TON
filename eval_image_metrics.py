...
def eval(args):
    ...
    pred_sample = scan_files_in_dir(args.pred_folder, postfix={'.jpg', '.png'})[0].path
    gt_sample = scan_files_in_dir(args.gt_folder, postfix={'.jpg', '.png'})[0].path
    img = Image.open(pred_sample)
